...
class FilmResourceIT {
    ...
    public static Film createEntity(EntityManager em) {
        Film film = new Film().images(DEFAULT_IMAGES).imagesContentType(DEFAULT_IMAGES_CONTENT_TYPE).description(DEFAULT_DESCRIPTION);
        return film;
    }
    ...
    public static Film createUpdatedEntity(EntityManager em) {
        Film film = new Film().images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
        return film;
    }
    ...
    void putNewFilm() throws Exception {
        ...
        updatedFilm.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateFilmWithPatch() throws Exception {
        ...
        partialUpdatedFilm.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
