...
class AlbumPhotoResourceIT {
    ...
    void putNewAlbumPhoto() throws Exception {
        ...
        updatedAlbumPhoto.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateAlbumPhotoWithPatch() throws Exception {
        ...
        partialUpdatedAlbumPhoto.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
