...
class PhotoResourceIT {
    ...
    public static Photo createEntity(EntityManager em) {
        Photo photo = new Photo().images(DEFAULT_IMAGES).imagesContentType(DEFAULT_IMAGES_CONTENT_TYPE).description(DEFAULT_DESCRIPTION);
        return photo;
    }
    ...
    public static Photo createUpdatedEntity(EntityManager em) {
        Photo photo = new Photo().images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
        return photo;
    }
    ...
    void putNewPhoto() throws Exception {
        ...
        updatedPhoto.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE);
    ...
    void fullUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
