...
class LivreResourceIT {
    ...
    public static Livre createEntity(EntityManager em) {
        Livre livre = new Livre().images(DEFAULT_IMAGES).imagesContentType(DEFAULT_IMAGES_CONTENT_TYPE).description(DEFAULT_DESCRIPTION);
        return livre;
    }
    ...
    public static Livre createUpdatedEntity(EntityManager em) {
        Livre livre = new Livre().images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
        return livre;
    }
    ...
    void putNewLivre() throws Exception {
        ...
        updatedLivre.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateLivreWithPatch() throws Exception {
        ...
        partialUpdatedLivre.description(UPDATED_DESCRIPTION);
