...
class SerieResourceIT {
    ...
    public static Serie createEntity(EntityManager em) {
        Serie serie = new Serie().images(DEFAULT_IMAGES).imagesContentType(DEFAULT_IMAGES_CONTENT_TYPE).description(DEFAULT_DESCRIPTION);
        return serie;
    }
    ...
    public static Serie createUpdatedEntity(EntityManager em) {
        Serie serie = new Serie().images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
        return serie;
    }
    ...
    void putNewSerie() throws Exception {
        ...
        updatedSerie.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.images(UPDATED_IMAGES).imagesContentType(UPDATED_IMAGES_CONTENT_TYPE).description(UPDATED_DESCRIPTION);
